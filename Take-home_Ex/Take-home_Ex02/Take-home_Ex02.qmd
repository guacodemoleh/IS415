...
Specifically, there are a significant number of 108 oscillating hotspots in the study area. Additionally, these villages may have remained as oscillating hotspots due to the [warmer autumn and winter seasons](https://www.taipeitimes.com/News/taiwan/archives/2023/10/25/2003808201).
...
Furthermore, Tainan City's Climate [data](https://en.climate-data.org/asia/republic-of-china-taiwan/tainan-city/tainan-city-983291/t/december-12/) in 2023 falling within our study period reflects an average temperature of 24.5**°**C, an optimal temperature for dengue fever transmission ([Tran et al., 2020](#0){style="font-size: 11pt;"}).
