...
-   Villages with a darker orange have values closer to 1 which signify that they have significant clustering and their neighbouring areas exhibit similar values. These villages seem to mostly gather at the centre of our study area.
...
Beginning from the epicentre of the study area, the values of Gi\* seems to decrease radially in general. Closer to the centre, the higher Gi\* values indicate a higher number of dengue cases whilst the lower Gi\* values indicate more randomness in the distribution of dengue cases in the villages.
