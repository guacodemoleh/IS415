...
The Moran I statistic standard deviate is 12.869, indicating that there is high spatial autocorrelation.
...
-   Villages with a lighter orange have values closer to 0 which signify that they have significant clustering and their neighbouring areas exhibit similar values. These villages seem to mostly disperse at the fringes of our study area.
...
Gi\* statistics helps to add definition to maps by estimating density distribution of events at the local level, which further allows for the assessment of spatial association in a study area or of a particular observation.

Additionally, it helps to identify statistically significant hotspots/coldspots.
...
Beginning from the epicentre of the study area, the values of Gi\* seem to decrease radially in general. Closer to the centre, the higher positive Gi\* values indicate a higher density of dengue cases whilst the higher negative Gi\* values indicate more randomness in the distribution of dengue cases in the villages.
...
In general, most of the study area is characterised by hotspots rather than coldspots. There are a significant number of oscillating hotspots in the study area.
...
Columbia Mailman School of Public Health (n.d.). Hot Spot Spatial Analysis.
