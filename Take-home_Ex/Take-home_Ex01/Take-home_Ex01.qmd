...
As there are many map outputs, let's save the files that we need before proceeding to the analysis segment. I have created a placeholder folder called 'analysis' to store all these files.
```{r}
...
```{r}
#| eval: false
write_rds(roads_tampines,"data/analysis/roads_tampines.rds")
write_rds(origin_tampines,"data/analysis/origin_tampines.rds")
write_rds(dest_tampines,"data/analysis/dest_tampines.rds")

write_rds(roads_downtown_core,"data/analysis/roads_downtown_core.rds")
write_rds(origin_downtown_core, "data/analysis/origin_downtown_core.rds")

write_rds(roads_woodlands,"data/analysis/roads_woodlands.rds")
write_rds(origin_woodlands, "data/analysis/origin_woodlands.rds")

write_rds(roads_cwc,"data/analysis/roads_cwc.rds")
write_rds(dest_cwc, "data/analysis/dest_cwc.rds")
```
